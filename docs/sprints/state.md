...
- Current ID: sprint-001-patch-002
- Retry Count: 0
- Next Planned: sprint-004

<!-- 2026-07-08 ユーザー指示: sprint-001-patch-002（文言一掃）完了後、Codex GPT-5.5 high のレビューを受け、
     指摘を修正してから sprint-004 に着手する。 -->
...
| sprint-001-patch-002 | active | [contract](sprint-001-patch-002.md) | - | - |
