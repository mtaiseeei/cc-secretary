...
**1つのprivate GitHub repoで、秘書・プロジェクト開発・Chatworkの文脈を一緒に育て、後から探せる秘書。**
記憶、成果物、開発中のプロジェクト、選択したChatwork roomの履歴は同じrepoでGit管理する。
...
| ファイル | 内容 |
|---|---|
| [product.md](spec/product.md) | 目的、対象ユーザー、G1〜G5、成功状態、非ゴール |
| [features.md](spec/features.md) | F01〜F27 とユーザーから見た振る舞い |
| [constraints.md](spec/constraints.md) | 安全・記憶保護・secret・single private repo・同期同意などの不変条件 |
| [domain.md](spec/domain.md) | 三層記憶、timeline、Chatwork取得・検索状態、時刻・索引・Git規約 |
| [ui.md](spec/ui.md) | 対話UX、Chatwork wizard、添付デザイン言語、3行報告、先回り提案 |
