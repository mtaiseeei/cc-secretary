...
記憶・成果物・通常のprojectを1つの非公開のGitHubリポジトリに置き、選択したChatworkルームの履歴も同じリポジトリで管理します。
...
考え方はシンプルです。**メールや予定は各サービスに置いたまま参照し、秘書・project・選択したChatwork履歴は1つの非公開のGitHubリポジトリで育てる**。
