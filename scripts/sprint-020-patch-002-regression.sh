...
check "Cloud準備moduleの構文" node --check "$ROOT/plugins/yasashii-secretary/skills/google-chat/scripts/cloud-setup.mjs"
check "Google Chat wizardの構文" node --check "$ROOT/plugins/yasashii-secretary/skills/google-chat/assets/wizard/app.js"
